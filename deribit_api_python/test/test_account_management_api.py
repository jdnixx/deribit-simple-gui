...
from openapi_client.api.account_management_api import AccountManagementApi  # noqa: E501
...
class TestAccountManagementApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = openapi_client.api.account_management_api.AccountManagementApi()  # noqa: E501
