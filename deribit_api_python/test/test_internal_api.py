...
class TestInternalApi(unittest.TestCase):
    ...
    def test_public_get_footer_get(self):
        """Test case for public_get_footer_get

        Get information to be displayed in the footer of the website.  # noqa: E501
        """
        pass

    def test_public_get_option_mark_prices_get(self):
        """Test case for public_get_option_mark_prices_get
